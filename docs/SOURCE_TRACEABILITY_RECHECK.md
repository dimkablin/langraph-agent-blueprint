...
| Agent/subagent tool | `src/tools/AgentTool`, `src/coordinator`, `src/tasks` | `agent`, `agent_graph`, `AgentService` | partial | redesigned_as_langgraph | Real child graph, tool scopes, persistence, stop/resume. | P1 | Phase 5. |
